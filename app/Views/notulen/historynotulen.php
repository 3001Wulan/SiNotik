          ...
          <div class="logo">
            ...
            <div class="menu">
                ...
                <a href="#" class="menu-item active">
                    ...
                    <span>Distribusi Notulensi</span>
                </a>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const menuWithPopup = document.querySelector('.menu-item-with-popup');
    const menuPopup = document.querySelector('.menu-popup');

    if (menuWithPopup && menuPopup) {
        menuWithPopup.addEventListener('mouseenter', function() {
            menuPopup.style.display = 'block';
        });

        menuWithPopup.addEventListener('mouseleave', function() {
